...
from src.pipeline.Detect_object.Faster_RCNN import Faster_RCNN
...
def train():
    ...
    wandb.init(project=PROJECT_NAME, name=f"FasterRCNN-{datetime.now().strftime('%m%d-%H%M')}")
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        torch.save(model.state_dict(), os.path.join(OUTPUT_DIR, "fasterRCNN_latest.pth"))
